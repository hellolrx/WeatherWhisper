...
class Settings(BaseSettings):
    ...
    qweather_geo_url: str = os.getenv("QWEATHER_GEO", "https://geoapi.qweather.com")
    qweather_base_url: str = os.getenv("QWEATHER_BASE", "https://devapi.qweather.com")
    ...
    def allow_origins(self) -> List[str]:
        origins_str = os.getenv("ALLOW_ORIGINS", "http://localhost:5173,http://127.0.0.1:5173")
